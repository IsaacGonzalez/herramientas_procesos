	...
	<body>
		...
		<div id="show-pregunta" class="content scaffold-show" role="main">
			...
			<ol class="property-list pregunta">
				...
				<g:if test="${preguntaInstance?.interrogante}">
				<li class="fieldcontain">
					<span id="interrogante-label" class="property-label"><g:message code="pregunta.interrogante.label" default="Interrogante" /></span>
					
						<span class="property-value" aria-labelledby="interrogante-label"><g:fieldValue bean="${preguntaInstance}" field="interrogante"/></span>
				...
				<li class="fieldcontain">
					<span id="respuesta-label" class="property-label"><g:message code="pregunta.respuesta.label" default="Respuesta" /></span>
						...
						<span class="property-value" aria-labelledby="respuesta-label"><g:fieldValue bean="${preguntaInstance}" field="respuesta"/></span>

			...
			<ol class="property-list usuario">
				...
				<li class="fieldcontain">
					<span id="rol-label" class="property-label"><g:message code="usuario.rol.label" default="Rol" /></span>
						...
						<span class="property-value" aria-labelledby="rol-label"><g:fieldValue bean="${usuarioInstance}" field="rol"/></span>
				...
				<g:if test="${usuarioInstance?.salidaRecibida}">
				<li class="fieldcontain">
					<span id="salidaRecibida-label" class="property-label"><g:message code="usuario.salidaRecibida.label" default="Salida Recibida" /></span>
					
						<span class="property-value" aria-labelledby="salidaRecibida-label"><g:link controller="salida" action="show" id="${usuarioInstance?.salidaRecibida?.id}">${usuarioInstance?.salidaRecibida?.encodeAsHTML()}</g:link></span>
